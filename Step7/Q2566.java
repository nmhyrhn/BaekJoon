...
public class Q2566 {
    public static void main(String[] args) throws IOException { // main 함수 시작 (입출력 예외 처리)
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); // 빠른 표준 입력을 위해 BufferedReader 사용
